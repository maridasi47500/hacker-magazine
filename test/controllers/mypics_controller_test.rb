...
class MypicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mypic" do
    assert_difference("Mypic.count") do
      post mypics_url, params: { mypic: { content: @mypic.content, image: @mypic.image, title: @mypic.title, user_id: @mypic.user_id } }
    end
  ...
  test "should update mypic" do
    patch mypic_url(@mypic), params: { mypic: { content: @mypic.content, image: @mypic.image, title: @mypic.title, user_id: @mypic.user_id } }
